...
public class RabbitMQConfig {
	...
	Queue newOrdersQueue() {
		return new Queue(properties.newOrdersQueue(), true);
	}

	@Bean
	Queue deliveredOrdersQueue() {
		return new Queue(properties.deliveredOrdersQueue(), true);
	}

	@Bean
	Queue cancelledOrdersQueue() {
		return new Queue(properties.cancelledOrdersQueue(),true);
	}

	@Bean
	Queue errorOrdersQueue() {
		return new Queue(properties.errorOrdersQueue(),true);
	}
