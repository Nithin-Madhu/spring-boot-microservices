...
class ProductEntity {
	...
	public ProductEntity(Long id, @NotEmpty(message = "Product code is required") String code,
			@NotEmpty(message = "Product name is required") String name, String description, String imageUrl,
